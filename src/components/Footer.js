        ...
        <div className='container' id="main-footer">
            <div id="media">
                <div className="footer-sec">
                    <img src="./imgs/flex-footer.png" className="flex-footer-logo d-inline-block align-top image-space" alt="Flex Consulting Logo"/>
                ...
                <a className='footer-sec footer-link' href="https://www.linkedin.com/company/flex-consulting-services" target="_blank" rel="noreferrer">
                    <img src="./imgs/linkedin-icon-18-256.png" className="linkedin-footer-logo d-inline-block align-top image-space" alt="Flex Consulting Logo"/>
                    <div id="organize-name">
