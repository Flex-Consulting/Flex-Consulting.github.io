        ...
        <div id="main-footer">
            <div id="media">
                <div className="footer-sec">
                    <img src="./Flex-Logo-White.png" width="100" height="100" className="d-inline-block align-top" alt="Flex Consulting Logo"/>
                    <div id="organize-name">
                        <p>Flex<br/>Consulting<br/>Services</p>
                    </div>
                </div>
                <div className='footer-sec'>
                    <img src="./linkedin-icon-18-256.png" width="50" height="50" className="d-inline-block align-top" alt="Flex Consulting Logo"/>
                    <div id="organize-name">
                        <p>LinkedIn</p>
                    </div>
                </div>
