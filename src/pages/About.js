        ...
        <Container>
            <section>
                <div className="center">
                    ...
                    <div className="about-sec animate__animated animate__fadeInLeft">
                        <h1 className="about-header">Our Story</h1>
                        <AboutCard text={AboutInfo["about"][0].text} opt={AboutInfo["about"][0].opt}/>
                    </div>
                    <div className="about-sec rev animate__animated animate__fadeInRight animate__delay-1s">
